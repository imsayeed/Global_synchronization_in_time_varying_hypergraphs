...
fp1=fopen("eps1=1.5_eps2_omega_3.out","w");
...
l= omega*ax30-2*sigr*ax20-ev2*(eps1*sig1r*ax20-eps1*sig1c*ay20+2*alpha2*sqrt(sigr/betar)*((cos(w*t0)*eps2*sig2r-sin(w*t0)*eps2*sig2c)*ax20+(-cos(w*t0)*eps2*sig2c-sin(w*t0)*eps2*sig2r)*ay20)); 
k14=l*h;
l=omega*ay30-2*betac*(sigr/betar)*ax20-ev2*(eps1*sig1c*ax20+eps1*sig1r*ay20+2*alpha2*sqrt(sigr/betar)*((sin(w*t0)*eps2*sig2r+cos(w*t0)*eps2*sig2c)*ax20\
+(-sin(w*t0)*eps2*sig2c+cos(w*t0)*eps2*sig2r)*ay20)); 
 k15=l*h;


l= -omega*ax20-2*sigr*ax30-ev3*(eps1*sig1r*ax30-eps1*sig1c*ay30+2*alpha2*sqrt(sigr/betar)*((cos(w*t0)*eps2*sig2r-sin(w*t0)*eps2*sig2c)*ax30+(-cos(w*t0)*eps2*sig2c-sin(w*t0)*eps2*sig2r)*ay30)); 
k17=l*h;
l=-omega*ay20-2*betac*(sigr/betar)*ax30-ev3*(eps1*sig1c*ax30+eps1*sig1r*ay30+2*alpha2*sqrt(sigr/betar)*((sin(w*t0)*eps2*sig2r+cos(w*t0)*eps2*sig2c)*ax30\
+(-sin(w*t0)*eps2*sig2c+cos(w*t0)*eps2*sig2r)*ay30)); 
 k18=l*h;
...
l= omega*ax3-2*sigr*ax2-ev2*(eps1*sig1r*ax2-eps1*sig1c*ay2+2*alpha2*sqrt(sigr/betar)*((cos(w*t)*eps2*sig2r-sin(w*t)*eps2*sig2c)*ax2+(-cos(w*t)*eps2*sig2c-sin(w*t)*eps2*sig2r)*ay2)); 
k24=l*h;
l=omega*ay3-2*betac*(sigr/betar)*ax2-ev2*(eps1*sig1c*ax2+eps1*sig1r*ay2+2*alpha2*sqrt(sigr/betar)*((sin(w*t)*eps2*sig2r+cos(w*t)*eps2*sig2c)*ax2+(-sin(w*t)*eps2*sig2c+cos(w*t)*eps2*sig2r)*ay2)); 
 k25=l*h;


l= -omega*ax2-2*sigr*ax3-ev3*(eps1*sig1r*ax3-eps1*sig1c*ay3+2*alpha2*sqrt(sigr/betar)*((cos(w*t)*eps2*sig2r-sin(w*t)*eps2*sig2c)*ax3+(-cos(w*t)*eps2*sig2c-sin(w*t)*eps2*sig2r)*ay3)); 
k27=l*h;
l=-omega*ay2-2*betac*(sigr/betar)*ax3-ev3*(eps1*sig1c*ax3+eps1*sig1r*ay3+2*alpha2*sqrt(sigr/betar)*((sin(w*t)*eps2*sig2r+cos(w*t)*eps2*sig2c)*ax3+(-sin(w*t)*eps2*sig2c+cos(w*t)*eps2*sig2r)*ay3)); 
 k28=l*h;
