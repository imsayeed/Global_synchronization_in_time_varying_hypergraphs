...
fp1=fopen("omega=4_ev2_ev3_sf1.out","w");
...
l= omega*ax30-2*sigr*ax20+eps1*ev2*ax20; 
k14=l*h;
l=omega*ay30-2*betac*(sigr/betar)*ax20-eps1*ev2*ay20; 
 k15=l*h;


l= -omega*ax20-2*sigr*ax30+eps1*ev3*ax30; 
k17=l*h;
l=-omega*ay20-2*betac*(sigr/betar)*ax30-eps1*ev3*ay30; 
 k18=l*h;
...
l= omega*ax3-2*sigr*ax2+eps1*ev2*ax2; 
k24=l*h;
l=omega*ay3-2*betac*(sigr/betar)*ax2-eps1*ev2*ay2; 
 k25=l*h;


l= -omega*ax2-2*sigr*ax3+eps1*ev3*ax3; 
k27=l*h;
l=-omega*ay2-2*betac*(sigr/betar)*ax3-eps1*ev3*ay3; 
 k28=l*h;
